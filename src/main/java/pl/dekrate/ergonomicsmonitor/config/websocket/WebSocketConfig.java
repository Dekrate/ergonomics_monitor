 ...
 *
 * <p>Provides real-time streaming of activity events and break recommendations to connected clients
 * via WebSocket connections.
 *
 * <p>Features: - Real-time activity event streaming - Break recommendation notifications -
 * Connection management - Configurable via application properties
 *
 * @author dekrate
 * @version 1.0
 * @since 1.0
...
public class WebSocketConfig {
    ...
    /**
     * Handler mapping for WebSocket endpoints. Maps URL paths to WebSocket handlers.
     *
