...
/**
 * Integration test for the database layer. Uses Testcontainers to spin up a real PostgreSQL
 * instance. Verifies that custom R2DBC converters correctly handle JSONB metadata mapping.
 */
@SpringBootTest
@Testcontainers
